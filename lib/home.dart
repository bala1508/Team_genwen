...
class _HomeState extends State<Home> {
  Future<String?> attemptLogIn(String uid, String password) async {
    var res = await Requests.post("http://192.168.54.42:3001/auth/login",
          ...
          child: Column(
            ...
            children: [
              Center(
                ...
                height: 200,
                width: 300,
                child: Image.asset("assets/MUJ logo_High.png"),
              )),
              Center(
                  child: Text(
                "LOGIN",
  ...
  void login() async {
    ...
    if (a != null) {
      ...
      await storage.write(
          key: "details", value: jsonEncode(details['data']['user']));
      if (details['data']['user']['user_type'] == "student") {
        ...
        Navigator.push(
            context, MaterialPageRoute(builder: (context) => TeacherPanel()));
      }
    }
  }
}
