...
class _TeacherPanelState extends State<TeacherPanel> {
  ...
  Future<void> getSubjects(BuildContext context) async {
    ...
    final res = await Requests.get(
        "http://192.168.54.42:3001/faculty/subjects/${jsonDecode((await storage.read(key: "details"))!)['_id']}",
        headers: {
          ...
          child: Row(
            ...
            children: [
              Column(
                ...
                children: [
                  Text(
                    i["subject_name"].toString().toUpperCase(),
                  ...
                  Text(
                    i["subject_code"].toString().toUpperCase(),
